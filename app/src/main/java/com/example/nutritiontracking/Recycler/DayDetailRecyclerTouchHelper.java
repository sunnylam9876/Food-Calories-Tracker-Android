...
public class DayDetailRecyclerTouchHelper extends ItemTouchHelper.SimpleCallback {
    private DayDetailRecyclerAdapter adapter;

    public DayDetailRecyclerTouchHelper(DayDetailRecyclerAdapter adapter) {
